...
var scrollCarousel = () => {
  $(".carousel-control-prev, .carousel-control-next, .owl-dots").on(
    "click",
    function() {
    ...
    .owlCarousel({
      ...
      navText: [
        `<div class="carousel-control-prev" role="button" data-slide="prev">
                <div class="arrowbox">
                    <i class="fa fa-angle-left align-middle mt-4 mb-4"></i>
                </div>
                <span class="sr-only">Previous</span>
            </div>`,
        `<div class="carousel-control-next" role="button" data-slide="next">
                <div class="arrowbox">
                    <i class="fa fa-angle-right align-middle mt-4 mb-4"></i>
                </div>
...
var slideCarousel = () => {
  $(".owl-carousel").on("translate.owl.carousel", function() {
    if (
      ...
      $(this)
        .closest(".rect:hover")
        .css("box-shadow", "0px 2px 7px 2px rgba(0,0,0,.15)")
    }
  })
}
